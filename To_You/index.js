 ...
 */
 function typewrite()
 {
     let str="To 聪聪：<--真的不容易，终于来到了这个页面。粗略的统计了一下，前面的26段话一半儿来源百度知乎，一半儿都是我在发牢骚，前面这种种，总给我一种那个送你满是情话的贺卡一般的感觉，哎，不扯了不扯了。现在，终于可以好好说说心里话了。<--先来说说你给我的感觉吧，乐观开朗，极擅言谈的一个小姑娘，而这种性格，是我可望而不可及的。而我呢，不善交流，给人一种不好相处的感觉。但是，我感觉我好像有些变了，脸上多了笑容，也变的逐渐会分享。我始终不会忘记，你会记得我说过的一些话，也了解我的口味；而我也会记得，你喜欢阳光，喜欢星空，喜欢推理悬疑等等等等，而我也想过，或送你一颗星，又或送你一本书，但是，最终选择了这个方案，或许，这就是一个理工男孩儿的浪漫吧。（PS:虽然框架来源于B站，但是，我做了一些改动。）另外，很多个第一次在你的身上实现，第一次游戏开麦，第一次对着你抱着吉他唱歌（PS:虽然很烂，但也算！），第一次的特别关心等等…好了，该说的就先这么多吧，这里的这句话我觉得特别好——我愿意为你，写满整个世界的情诗，因为我喜欢你，因为…我也想给你哪怕一点点的浪漫，因为当代码不止是代码的时候，它就有了新的意义。<--那么，郭聪聪同学，我想要带你游遍祖国的大好河山，带你去感受不同地方的风土人情，带你走过好多好多…我们，在一起吧？";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
...
//             sea.style.opacity=1;
//             box1.style.zIndex=-201;
//             sea.style.zIndex=-200;
//             wave1.style.zIndex=-200;
//             wave2.style.zIndex=-200;
             ...
             btn_2.style.transition="1.5s";
             btn__2.style.transition="1.5s";
             str="<<<怎么样？<我这网页做的效果还可以吧~<别多想，别多想，我只是展示一下我的成果<哈哈哈哈哈哈哈哈哈哈哈";
             box2.style.zIndex=8;
             box2.style.opacity=1;
             show(str, 'box2');
             }
